          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 text-center md:text-left">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-500">
                ...
                <li><a href="#" className="hover:text-black">Home & Garden</a></li>
                <li><a href="#" className="hover:text-black">Sports</a></li>
                <li><a href="#" className="hover:text-black">Deals</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-500">
                <li><a href="#" className="hover:text-black">About ShopMart</a></li>
